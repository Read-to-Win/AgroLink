...
const Join = () => {
  ...
  return (
    <div className="bg-[#214538] min-h-screen text-white flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg bg-[#214538]/90 border border-white/10 backdrop-blur-sm rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="rounded-xl border border-gray-600 bg-[#202820] text-white focus:outline-none focus:ring-2 focus:ring-[#14B714] px-4 py-2 w-full"
            />
            {errors.fullName && (
          ...
          <div className="col-span-1 md:col-span-2 mt-2">
            <button
              className="w-full px-4 py-2 rounded-full bg-[#14B714] hover:bg-[#119911] disabled:opacity-50 transition font-semibold"
