...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f4f4]">
      {/* Navbar */}
      <nav className="w-full bg-[#1a2a1a] p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 shadow-lg">
      ...
      <div className="p-6">
        <h2 className="text-center text-gray-800 text-3xl font-semibold mb-6">
          All Products
        </h2>
